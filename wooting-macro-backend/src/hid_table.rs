...
pub static ref MULTIINPUT_TO_HID: HashMap<KeyId, u32> = {
    let mut scancode: HashMap<KeyId, u32> = HashMap::new();
        ...
        scancode.insert(KeyId::MediaNextTrack, 0xB0); //NEXT_TRACK
        scancode.insert(KeyId::MediaPrevTrack, 0xB1); //PREV_TRACK
        scancode.insert(KeyId::MediaStop, 0xB2); //STOP_TRACK
        scancode.insert(KeyId::MediaPlayPause, 0xCD); //PLAY_PAUSE_TRACK
...
pub static ref HID_TO_MULTIINPUT: HashMap<u32, KeyId> = {
    let mut scancode: HashMap<u32, KeyId> = HashMap::new();
        ...
        scancode.insert(0xB0 ,KeyId::MediaNextTrack); //NEXT_TRACK
        scancode.insert(0xB1 ,KeyId::MediaPrevTrack); //PREV_TRACK
        scancode.insert(0xB2 ,KeyId::MediaStop); //STOP_TRACK
        scancode.insert(0xB3 ,KeyId::MediaPlayPause); //PLAY_PAUSE_TRACK
